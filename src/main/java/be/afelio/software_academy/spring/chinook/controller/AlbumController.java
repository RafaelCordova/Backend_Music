...
public final class AlbumController {
	...
	public ResponseEntity<ReponseDto<AlbumDto>> deleteAlbum(@PathVariable("id") int id) {
		ReponseDto<AlbumDto> dto;
	...
	public ResponseEntity<ReponseDto<List<AlbumDto>>> findAllAlbumByGenreNameDtoWithMapping(@PathVariable("Name") String name) {
